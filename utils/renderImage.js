...
function loadFolderImages(path) {	
...
// loadFolderImages("./assets/background")

// console.log(Object.keys(images))

// registerFont(__dirname+'/swordgame/font/Ginto Nord Medium.otf', { family: 'Ginto Nord Medium' });
// registerFont(__dirname+'/swordgame/font/Ginto Nord Black.otf', { family: 'Ginto Nord Black' });
...
module.exports = async function renderImage(state, messages, player, creature, rand, training=false, lang="en") {
	// Create a new canvas
    const canvas = createCanvas(1000, 600);
    const ctx = canvas.getContext('2d');

    // Draw background
	// const randomBg = rand.choice(fs.readdirSync("/assets/background")).split(".png")[0]
