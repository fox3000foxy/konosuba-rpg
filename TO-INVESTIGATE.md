...
- Ajouter des tests dédiés pour la stabilité du rendu d’info monstre.
- Vérifier que les ids d’autocomplétion restent stables si on ajoute ou réordonne des mobs.
- Vérifier le comportement du endpoint API sur les monstres génériques.